  ...
  switch (groupTemplate.style) {
    ...
    case 'partogram':
      if (props.partogramPosition) {
        ...
        let posX = x - 4.5;
        let arrayPos = {
          'OP': `translate(${posX}, ${posY})`,
          'OEA': `translate(${posX}, ${posY}) rotate(45.000000) translate(-12.000000, -12.000000) translate(2.000000, 2.000000)`,
          'OET': `translate(${posX}, ${posY}) rotate(90.000000) translate(-12.000000, -12.000000) translate(2.000000, 2.000000)`,
          'OEP': `translate(${posX}, ${posY}) rotate(135.000000) translate(-12.000000, -12.000000) translate(2.000000, 2.000000)`,
          'ODP': `translate(${posX}, ${posY}) rotate(225.000000) translate(-12.000000, -12.000000) translate(2.000000, 2.000000)`,
          'ODT': `translate(${posX}, ${posY}) rotate(270.000000) translate(-12.000000, -12.000000) translate(2.000000, 2.000000)`,
          'ODA': `translate(${posX}, ${posY}) rotate(315.000000) translate(-12.000000, -12.000000) translate(2.000000, 2.000000)`,
          'OS': `translate(${posX}, ${posY}) rotate(180.000000) translate(-12.000000, -12.000000) translate(2.000000, 2.000000)`,
          'IND': `translate(${posX}, ${posY})`
        };
        let group = exports.getSVGElement('g', JSONcontainer, svgContainer);
        group.setAttributeNS(null, 'stroke', '#8C8C8C');
        group.setAttributeNS(null, 'stroke-width', '2');
        group.setAttributeNS(null, 'transform', arrayPos[props.partogramPosition]);

        let circle = exports.getSVGElement('circle', JSONcontainer, svgContainer);
        circle.setAttributeNS(null, 'stroke', '#8C8C8C');
        ...
        if (props.partogramPosition !== 'IND') {
          let line1 =  exports.getSVGElement('line', JSONcontainer, svgContainer)
          line1.setAttributeNS(null, 'stroke', '#8C8C8C');
          line1.setAttributeNS(null, 'stroke-width', '2');
          line1.setAttributeNS(null, 'x1', '10');
          line1.setAttributeNS(null, 'y1', '7.16764966');
          line1.setAttributeNS(null, 'x2', '10');
          line1.setAttributeNS(null, 'y2', '20');
          group.append(line1);

          let line2 =  exports.getSVGElement('line', JSONcontainer, svgContainer)
          line2.setAttributeNS(null, 'stroke', '#8C8C8C');
          line2.setAttributeNS(null, 'stroke-width', '2');
          line2.setAttributeNS(null, 'x1', '16');
          line2.setAttributeNS(null, 'y1', '7.58382483');
          line2.setAttributeNS(null, 'x2', '10');
          line2.setAttributeNS(null, 'y2', '3');
          line2.setAttributeNS(null, 'transform', 'translate(13.000000, 5.083825) scale(-1, 1) translate(-13.000000, -5.083825) ');
          group.append(line2);

          let line3 =  exports.getSVGElement('line', JSONcontainer, svgContainer)
          line3.setAttributeNS(null, 'stroke', '#8C8C8C');
          line3.setAttributeNS(null, 'stroke-width', '2');
          line3.setAttributeNS(null, 'x1', '10');
          line3.setAttributeNS(null, 'y1', '7.79191242');
          line3.setAttributeNS(null, 'x2', '4');
          line3.setAttributeNS(null, 'y2', '3');
          group.append(line3);
        }
