...
Graph2d.prototype.getEventProperties = function (event) {
  ...
  var what = null;
  let yAxisLeftFrame = null;
  let yAxisLeft = this.linegraph.yAxisLeft;
  if (this.linegraph.yAxisLeft.dom) yAxisLeftFrame = this.linegraph.yAxisLeft.dom.frame 
  else {
    const frameDom = this.linegraph.yAxisLeft[this.linegraph.yAxisLeft.length - 1];
  ...
  else if (util.hasParent(element, yAxisLeftFrame))   {what = 'data-axis';}
