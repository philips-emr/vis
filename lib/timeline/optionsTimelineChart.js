...
let allOptions = {
  ...
  drawPoints: {
    ...
    size: {number},
    style: {string:['square','circle', 'trend', 'triangle-up', 'triangle-down', 'arrow-avg', 'partogram']}, // square, circle
    __type__: {object,boolean,'function': 'function'}
  },
  dataAxis: {
  ...
  gap: {number},
  itemsFit: {array},
  elementsTimelineSettingBarItem: {any,'undefined': 'undefined'},
...
let configureOptions = {
  global: {
    ...
    drawPoints: {
      enabled: true,
      size: [6,2,30,1],
      style: ['square', 'circle', 'arrow-avg', 'partogram'] // square, circle
    },
    dataAxis: {
      minorLinesOffset: 0,
