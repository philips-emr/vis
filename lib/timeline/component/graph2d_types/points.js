...
Points.draw = function (dataset, group, framework, offset) {
  ...
  for (var i = 0; i < dataset.length; i++) {
    let point;
    const d = dataset[i];
    const { maxValue, avgValue, minValue, alertMin, alertMax, alertMed, alertColor, screen_yMin, screen_yAvg, screen_yMax, calculateAllPoints, partogramPosition, partogramContraction, stylePoint } = d;
    const props = {
      maxValue,
      avgValue,
      minValue,
