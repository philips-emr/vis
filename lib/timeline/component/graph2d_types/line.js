...
Line.drawShading = function (pathArray, group, subPathArray, framework) {
    ...
    if (group.options.shaded.enabled == true) {
        ...
        if (!isNaN(pathArray[0][1]) && !isNaN(pathArray[0][1]) && group.options.shaded.orientation == 'group' && (subPathArray != null && subPathArray != undefined)) {
        ...
        else if (!isNaN(pathArray[0][1]) && !isNaN(pathArray[0][1])) {
            dFill = 'M' + pathArray[0][0]+ ","+pathArray[0][1] + " " +
                    this.serializePath(pathArray,type,false) +
