...
TimeAxis.prototype._repaintLabels = function () {
  ...
  const elementHeaderWidthItem = elementHeaderWidth.querySelectorAll('.tl-setting-bar__item');
...
TimeAxis.prototype._repaintMinorLine = function (left, width, orientation, className, indexColumn) { 
  ...
  fastdom.measure(function () {
    ...
    const y = orientation == 'top' ? props.majorLabelHeight : _this.body && _this.body.domProps.top.height;
