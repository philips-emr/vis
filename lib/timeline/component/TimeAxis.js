...
TimeAxis.prototype._repaintLabels = function () {
  ...
  if (gap == 0 && this.body.range.options.itemsFit) {
    columnCount = (columnCount < this.body.range.options.itemsFit.length) ? this.body.range.options.itemsFit.length : columnCount;
  }
...
TimeAxis.prototype._repaintMinorLine = function (left, width, orientation, className, indexColumn) {
  ...
  const y = orientation == 'top' ? props.majorLabelHeight : this.body.domProps.top.height;
