...
DataAxis.prototype._create = function() {
  let { dom, svg, height, options } = this;
...
DataAxis.prototype._redrawLine = function (y, orientation, className, offset, width) {
  const { DOMelements, dom, body, master } = this;
  const withThis = this.width;
  fastdom.measure(function () {
    if (master === true) {
      const line = DOMutil.getDOMElement('div', DOMelements.lines, dom.lineContainer);//this.dom.redundant.lines.shift();
